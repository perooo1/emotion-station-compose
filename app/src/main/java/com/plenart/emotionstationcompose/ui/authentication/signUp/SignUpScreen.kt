...
fun SignUpScreen(modifier: Modifier = Modifier) {
    Box(
        ...
        Column(
            ...
            Text(text = stringResource(R.string.authentication_sign_up_hero_label))
            Spacer(modifier = Modifier.height(MaterialTheme.spacing.small))
            OutlinedTextField(
            ...
            Row(
                ...
                Text(text = stringResource(R.string.authentication_already_have_an_account))
                TextButton(modifier = Modifier.width(80.dp), onClick = {

                }) {
                    Text(text = stringResource(R.string.authentication_sign_in_here_button_label))
                }
            }
        }
    }
